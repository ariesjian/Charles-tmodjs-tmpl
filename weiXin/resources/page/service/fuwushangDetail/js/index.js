;$(document).ready(function () {
    ...
    !(function($,request,tpl,wu){
        ...
        var wrap = {
            ...
            urls:{
                'getServiceMerchantDetail':'/index.php/index/service_system/getServiceMerchantDetail'
            },
            ...
            getContent:function (callback) {
                ...
                var self = this;
                request({
                    url:self.urls.getServiceMerchantDetail,
            ...
            getHiddenData:function () {
                ...
                return {
                    merchant_id:$('#merchant_id').val().trim(),
                }
            },
            getParamsOfGetActivityDetail:function () {
                //传给接口的数据
                return {
                    merchant_id:this.getHiddenData().merchant_id
                }
            },
