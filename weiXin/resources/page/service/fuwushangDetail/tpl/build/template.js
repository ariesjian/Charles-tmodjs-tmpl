...
/**/) {
'use strict';var $utils=this,$helpers=$utils.$helpers,merchant=$data.merchant,$string=$utils.$string,getImgPath=$helpers.getImgPath,$out='';if(merchant){
$out+='\r\n\r\n<div class="mobile_outcontainer">\r\n    <div class="mobile_nopadding_container1">\r\n        <div class="c_zone_introtop"><img src="';
$out+=$string(merchant.banner_url||getImgPath('zone_introduce_img1.png'));
$out+='" /></div>\r\n        <div class="c_zone_introdetail">\r\n            <div class="c_zone_company_box1">\r\n                <div class="c_zone_company_box1_inner">\r\n                    <span>';
$out+=$string(merchant.name);
$out+='</span><label>';
$out+=$string(merchant.summary);
$out+='</label>\r\n                </div>\r\n            </div>\r\n            <div class="c_zone_introdetail_box2">\r\n                <div class="c_zone_introdetail_box2_title"><b></b><span>服务商介绍</span></div>\r\n                <div class="c_zone_introdetail_box2_des">';
$out+=$string(merchant.detail);
$out+='</div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n    ';
if(merchant.link){
$out+='\r\n    <div class="c_service_footer_btn">\r\n        <a href="';
$out+=$string(merchant.link);
$out+='" class="c_service_footer_btn_inner" style="cursor:pointer;" >前往</a>\r\n    </div>\r\n</div>\r\n';
}
$out+='\r\n';
}else{
