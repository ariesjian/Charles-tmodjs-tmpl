...
/**/) {
'use strict';var $utils=this,$helpers=$utils.$helpers,space_list=$data.space_list,i=$data.i,info=$data.info,$string=$utils.$string,getImgPath=$helpers.getImgPath,$out='';$out+='\r\n';
if(space_list && space_list.length){
...
$out+='\r\n            <a href="/index.php/index/office/pageOfficeList?space_id=';
$out+=$string(info.id);
