...
/*``*/) {
'use strict';var $utils=this,$helpers=$utils.$helpers,errMsg=$data.errMsg,$string=$utils.$string,getImgPath=$helpers.getImgPath,d=$data.d,order=$data.order,reserve_date=$data.reserve_date,start_time=$data.start_time,end_time=$data.end_time,g=$data.g,e=$data.e,v=$data.v,$out='';if(errMsg){
...
$out+='</div>\n                </div>\n                ';
if(d.increment_services&&d.increment_services.length){
$out+='\n                <div class="weui-cell">\n                    <div class="weui-cell__bd">\n                        <p>增值服务</p>\n                    </div>\n                    <div class="weui-cell__ft">\n                        ';
$out+=$string(d.increment_services.map(function(v){
                            return v.name
                        }).join(','));
$out+='\n                    </div>\n                </div>\n                ';
}
$out+='\n                <div class="weui-cell">\n                    <div class="weui-cell__bd">\n                        <p>总金额</p>\n                    </div>\n                    <div class="weui-cell__ft">&yen;';
$out+=$string(d.total_price||0);
$out+='</div>\n                </div>\n            </div>\n        </div>\n\n        <div class="c_station_reserve_btn"><a href="/index.php/index/meeting/pageMeetingRoomOrderDetail?order_id=';
$out+=$string(d.id);
$out+='" class="c_station_reserve_btn_inner c_room_reserve_btn_inner">查看订单详情</a></div>\n\n    </div>\n</div>\n';
}
