...
/**/) {
'use strict';var $utils=this,$helpers=$utils.$helpers,space_list=$data.space_list,i=$data.i,info=$data.info,$string=$utils.$string,getImgPath=$helpers.getImgPath,$out='';if(space_list && space_list.length){
