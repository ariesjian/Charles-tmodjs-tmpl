...
/**/) {
'use strict';var $utils=this,$helpers=$utils.$helpers,companyDetails=$data.companyDetails,i=$data.i,info=$data.info,$string=$utils.$string,getImgPath=$helpers.getImgPath,$out='';if(companyDetails && companyDetails.length){
$out+='\r\n<div class="mobile_outcontainer">\r\n    <div class="mobile_nopadding_container2">\r\n\r\n        ';
for(var i=0;i< companyDetails.length;i++){
        var info = companyDetails[i];
        
$out+='\r\n        <div class="c_zone_introtop"><img src=" ';
$out+=$string(info.backgroundur||getImgPath('zone_teacherdetail_img1.png'));
