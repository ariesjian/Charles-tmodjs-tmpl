...
/**/) {
'use strict';var $utils=this,$helpers=$utils.$helpers,order_list=$data.order_list,statusMap=$data.statusMap,i=$data.i,d=$data.d,$string=$utils.$string,JSON=$data.JSON,getImgPath=$helpers.getImgPath,$out='';if(order_list&&order_list.length){
var statusMap = {'0':'待付款','1':'已支付（审核中）','2':'已交付（审核通过）','3':'审核失败','9':'已超时取消'}
...
$out+=$string(d.workplace_list_img_url);
$out+='" /></div>\n                        <div class="c_station_minelist_inner1_right">\n                            <span class="c_station_minelist_inner1_right1">';
$out+=$string(d.workplace_name);
$out+='</span>\n                            <span class="c_station_minelist_inner1_right2">';
$out+=$string(d.workplace_count);
$out+='位</span>\n                            <span class="c_station_minelist_inner1_right3">&yen;';
$out+=$string(d.workplace_price);
$out+='/位/月</span>\n                        </div>\n                    </a>\n                    <div class="c_station_minelist_inner2">\n\n                        ';
if(0==d.status){
$out+='\n                            <div class="c_station_minelist_inner2_left c_station_minelist_status4">';
$out+=$string(statusMap[d.status]);
$out+='</div>\n                            <div class="c_station_minelist_inner2_right">\n                                <a href="/index.php/index/workplace/pageOrderDetail?order_id=';
$out+=$string(d.id);
$out+='" style="cursor:pointer;" >去支付</a>\n                            </div>\n                        ';
}else if(1==d.status){
$out+='\n                            <div class="c_station_minelist_inner2_left c_station_minelist_status1">已支付<label class="c_minelist_leftcolor">（审核中）</label></div>\n                            <div class="c_station_minelist_inner2_right">\n                            </div>\n                        ';
}else if(2==d.status){
$out+='\n                            <div class="c_station_minelist_inner2_left c_station_minelist_status1">已交付<label class="c_minelist_leftcolor">（审核通过）</label></div>\n                            <div class="c_station_minelist_inner2_right">\n                                <a href="javascript:void(0);" style="cursor:pointer;" id="continue" data-order=';
...
$out+='" /></b>\n    <span class="c_nodata_box3_txt">没有您预定的工位</span>\n</div>\n';
}
