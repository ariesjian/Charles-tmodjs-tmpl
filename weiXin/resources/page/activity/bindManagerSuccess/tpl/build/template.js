...
/**/) {
'use strict';var $utils=this,$helpers=$utils.$helpers,$string=$utils.$string,getImgPath=$helpers.getImgPath,activity_name=$data.activity_name,manager_name=$data.manager_name,manager_mobile=$data.manager_mobile,activity_start_time=$data.activity_start_time,g=$data.g,activity_end_time=$data.activity_end_time,activity_address=$data.activity_address,activity_id=$data.activity_id,$out='';$out+='<div class="mobile_outcontainer">\n    <div class="mobile_nopadding_container1">\n\n        <div class="c_station_reserve">\n            <div class="c_station_reserve_inner">\n                <b class="c_station_reserve_inner_img"><img src="';
$out+=$string(getImgPath('enroll_success.png'));
$out+='" /></b>\n                <label class="c_station_reserve_inner_txt1">绑定成功</label>\n                <label class="c_station_reserve_inner_txt2">';
...
$out+=$string(manager_name);
$out+='</div>\n                    </div>\n                </div>\n                <div class="c_ordersuccess_box">\n                    <div class="weui-cell">\n                        <div class="weui-cell__bd">\n                            <p>联系方式</p>\n                        </div>\n                        <div class="weui-cell__ft">';
$out+=$string(manager_mobile);
$out+='</div>\n                    </div>\n                    <div class="weui-cell">\n                        <div class="weui-cell__bd">\n                            <p>活动时间</p>\n                        </div>\n                        <div class="weui-cell__ft">';
...
$out+='</div>\n                    </div>\n                </div>\n            </div>\n        </div>\n\n        <div class="c_activity_enroll_btn"><a href="/index.php/index/activity/pageActivityDetail?activity_id=';
$out+=$string(activity_id);
$out+='" class="c_activity_enroll_btn_inner">查看活动详情</a></div>\n\n    </div>\n</div>';
