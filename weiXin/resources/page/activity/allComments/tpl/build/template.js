...
/**/) {
'use strict';var $utils=this,$helpers=$utils.$helpers,comments=$data.comments,i=$data.i,cmt=$data.cmt,score=$data.score,$string=$utils.$string,getImgPath=$helpers.getImgPath,g=$data.g,is_manager=$data.is_manager,$out='';if(comments && comments.length){
$out+='\n<div class="mobile_outcontainer">\n    <div class="mobile_nopadding_container1">\n\n        <div class="c_morecomment_con">\n            <div class="c_morecomment_con_inner">\n                <div class="c_activity_detailall_content_comment">\n                    <ul class="c_activity_detailall_content_comment_ul" id="Comments">\n                        ';
for(var i=0;i<comments.length;i++){
                        var cmt = comments[i];
                        var score = cmt.score;
                        
$out+='\n                        <li class="j-comment c_activity_detailall_content_comment_ul_li" data-comment_id="';
$out+=$string(cmt.id);
...
$out+='\n                                    <a href="javascript:;" style="cursor:pointer;" class="j-reply c_activity_detailcomment_right3_right"><img src="';
