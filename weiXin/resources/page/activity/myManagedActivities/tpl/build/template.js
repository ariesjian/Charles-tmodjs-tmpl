...
/**/) {
'use strict';var $utils=this,$helpers=$utils.$helpers,activities=$data.activities,i=$data.i,d=$data.d,activity_type=$data.activity_type,$string=$utils.$string,g=$data.g,getActivityDescByType=$helpers.getActivityDescByType,getImgPath=$helpers.getImgPath,$out='';if(activities && activities.length){
...
$out+='\n                <li>\n                    <div class="j-item c_activity_minelist_inner1" data-id="';
$out+=$string(d.id);
...
$out+=$string(getActivityDescByType(activity_type));
$out+='</div>\n                        <div class="c_activity_minelist_inner2_right">\n                            <a href="/index.php/index/activity/pageActivityEnrollList?activity_id=';
$out+=$string(d.id);
$out+='">已报名列表</a>\n                        </div>\n                    </div>\n\n                </li>\n                ';
}
$out+='\n            </ul>\n        </div>\n    </div>\n</div>\n\n';
...
$out+='" /></b>\n    <span class="c_nodata_box3_txt">没有您负责的活动</span>\n</div>\n';
}
